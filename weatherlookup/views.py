...
def home(request):
    ...
    if request.method == "POST":
        ...
        try:
            api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode="+zipcode+"&distance=25&API_KEY=B5FD5F0C-090F-4834-8FA6-F1AF48A7147F")
        ...
        return render(request, 'home.html', {"message":"Welcome to the Weather App"})
